...
let
  ...
  python =
    runCommand "python"
      ...
      makeWrapper ${localPython}/bin/local-python $out/bin/py \
       ...
       --prefix LD_LIBRARY_PATH : ${lib.makeLibraryPath [pkgs.stdenv.cc.cc libGL libGLU]}
    '';
  ...
  run = writeScriptBin "run"
    ''
      ${python}/bin/py main.py --base-directory /mnt/f/gen/comfy-base --output-directory /mnt/l/comfy/
    '';
in
{
